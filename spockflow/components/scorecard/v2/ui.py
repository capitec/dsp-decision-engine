...
from spockflow.components.scorecard.v2.common import DefaultScorePattern, RangeScorePattern
from spockflow.components.scorecard.v2.criteria_categorical import ScoreCriteriaCategorical, CategoricalDiscreteScorePattern
from spockflow.components.scorecard.v2.criteria_numerical import ScoreCriteriaNumerical, Bounds, NumericalDiscreteScorePattern
...
class DiscreteScorePatternViewModel(traitlets.HasTraits):
    ...
    @staticmethod
    def from_pydantic_model(model: 'CategoricalDiscreteScorePattern[typing.Optional[str]]'):
