...
# -*- coding: utf-8 -*-
#
# pylitegraph documentation build configuration file
#
...
_version_py = os.path.join(repo, 'pylitegraph', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'pylitegraphdoc'
...
latex_documents = [
    (master_doc, 'pylitegraph.tex', 'pylitegraph Documentation',
     'Sholto', 'manual'),
]
